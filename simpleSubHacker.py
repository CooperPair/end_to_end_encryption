...
nonLettersOrSpacePattern = re.compile('[^A-Z\s]') # to remove charactrer from the string that are not uppercase letters or spaces
...
def main():
    ...
    # the returned cipherletter mapping will passed to below funciton to decrypt the ciphertext in msg.
